...
PARENT_DIR="/media/vinglabs/vinglabs_ssd/16_09/"
IMAGE_DIR="images/"
...
#/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python val.py --data dataset.yaml --weight best.pt --imgsz 640 --conf-thres 0.5 --iou-thres 0.5 --save-txt --batch-size 256 --project $PARENT_DIR$YOLO_OUTPUT
