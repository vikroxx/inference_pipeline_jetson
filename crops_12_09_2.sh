...
PARENT_DIR="/media/vinglabs/vinglabs_hdd1/12_09/opaque/"
IMAGE_DIR="images/"
...
cd $CURRENT_DIR
/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python edit_dataset_yaml.py --yolo_dir $YOLO_SCRIPT_DIR --image_dir $PARENT_DIR$UNDISTORTED_OUTPUT

cd $YOLO_SCRIPT_DIR

/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python val.py --data dataset.yaml --weight best.pt --imgsz 640 --conf-thres 0.5 --iou-thres 0.5 --save-txt --batch-size 64 --project $PARENT_DIR$YOLO_OUTPUT
