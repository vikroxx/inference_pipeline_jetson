...
PARENT_DIR="/home/vikrant/Desktop/09_10_22/"
IMAGE_DIR="images/"
...
LEFT_IMAGE_INDEX="0"
BOTTLE_CROP_DIR="yolo_crops_split/bottle/"
MERGED_IMAGES_DIR="merged_images_for_tracking"

YOLO_SCRIPT_DIR="/home/vikrant/Desktop/inference_pipeline_jetson/yolov5-master/"
UNDISTORTED_SCRIPT_DIR="/home/vikrant/Desktop/inference_pipeline_jetson/undistortion/"
YOLO_CROP_DIR="/home/vikrant/Desktop/inference_pipeline_jetson/yolo_crop/"

BOTTLE_NO_BOTTLE_SCRIPT_DIR="/media/vinglabs/dev/vikrant_pipeline/bottle_no_bottle_cans_classification/"
COLOR_SCRIPT_DIR="/media/vinglabs/dev/vikrant_pipeline/color_classification/"
...
cd $CURRENT_DIR
/usr/bin/python edit_dataset_yaml.py --yolo_dir $YOLO_SCRIPT_DIR --image_dir $PARENT_DIR$UNDISTORTED_OUTPUT

cd $YOLO_SCRIPT_DIR

/usr/bin/python val.py --data dataset.yaml --weight best.pt --imgsz 640 --conf-thres 0.5 --iou-thres 0.5 --save-txt --batch-size 4 --project $PARENT_DIR$YOLO_OUTPUT
...
#/usr/bin/python test_vertical_tracking.py --image_dir $PARENT_DIR$UNDISTORTED_OUTPUT --label_dir $PARENT_DIR$YOLO_LABELS --final_dir $PARENT_DIR$YOLO_TO_PICKLE_UNIQUE --left_image_index $LEFT_IMAGE_INDEX
...
#cd $CURRENT_DIR
#/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python edit_params.py --source $PARENT_DIR$BOTTLE_CROP_DIR --output $PARENT_DIR$COLOR_OUTPUT --json $COLOR_SCRIPT_DIR$PARAMETER_JSON
#cd $COLOR_SCRIPT_DIR$DETECT_EXEC_DIR
#/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python detect_exec.py
#cd $CURRENT_DIR
#echo $PARENT_DIR$COLOR_OUTPUT $PARENT_DIR$YOLO_CROPOUTS
#/media/vinglabs/dev/virtual_envs_new/inference_env_trt/bin/python split_color_folder_from_labels.py --label_dir $PARENT_DIR$COLOR_OUTPUT --image_dir $PARENT_DIR$YOLO_CROPOUTS
