...
PARENT_DIR="/home/vikrant/Desktop/virtual_drive/30_08/"
IMAGE_DIR="images/"
...
/usr/bin/python yolo_crop.py --image_dir $PARENT_DIR$UNDISTORTED_OUTPUT --label_dir $PARENT_DIR$YOLO_LABELS --classified_dir $PARENT_DIR$YOLO_CROPOUTS
